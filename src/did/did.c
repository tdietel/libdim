...
print_service_formatted(buff, size)
void *buff;
int size;
{
char type;
...
print_service_standard(buff, size)
int *buff, size;
{
int i,j, str_flag = 0;
...
print_service_longlong(buff, size)
longlong *buff, size;
{
int i,j, str_flag = 0;
char *asc, *ptr, str[80], tmp[256];
...
{
Widget fd, rc, sw, lb, rc1, rc2, rc3, bt;
XmString xm1;
Arg ar[20];
int n, par, reason;
